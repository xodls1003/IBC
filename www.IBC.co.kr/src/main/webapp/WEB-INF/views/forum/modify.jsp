			...
			<div class="panel-body">
				...
				<form role="form" action="/forum/modify" method="post">
					...
					<div class="form-group">
						...
						<textarea class="form-control" rows="3" name='fcontent'><c:out
								value="${forum.fcontent}" /></textarea>
					</div>
					...
					<div class="form-group">
						<label>RegDate</label> <input class="form-control" name='fregDate'
							value='<fmt:formatDate pattern = "yyyy/MM/dd" value = "${forum.fregdate}" />'
							readonly="readonly">
					</div>

	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label>ftitle</label> <input class="form-control" name='ftitle'
				...
				<form id='operForm' action="/forum/modify" method="get">
					<input type='hidden' id='fno' name='fno'
						value='<c:out value="${forum.fno}"/>'> <input
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label>Reply</label> <input class="form-control" name='frcontent'
						value='frcontent'>
				</div>
				<div class="form-group">
					<label>Replyer</label> <input class="form-control" name='frwriter'
						value='frwriter'>
				</div>
				<div class="form-group">
					<label>Reply Date</label> <input class="form-control"
						name='frregdate' value='frregdate'>
				</div>
